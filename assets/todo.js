...
theme.addEventListener('click', function() {
    if (theme.classList.toggle('change-color')) {
        document.body.style.background = "rgb(6, 8, 30)";
    } else {
        document.body.style.background = "linear-gradient(90deg, rgba(9, 14, 63, 1) 0%, rgba(113, 14, 25, 1) 100%, rgba(32, 199, 149, 1) 100%)";
    }
});
...
function createTodoDiv(todo) {
    ...
    completeBtn.addEventListener('click', function() {
        if (completeBtn.innerHTML === '<i class="fa-regular fa-pen-to-square"></i>') {
